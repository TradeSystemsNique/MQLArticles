...
| **OrderBlock** | - Main.mqh<br>- Order Block EA MT5.mq5<br>- OrderBlockIndPart2.mq5 | Contains the Order Block indicator and bot used as examples in the risk management, breakeven, and partials article series. |
