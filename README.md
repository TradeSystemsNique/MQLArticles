...
| **Ob** | - **Ea/**<br>&nbsp;&nbsp;&nbsp;&nbsp;- Ob_artc_19682.mq5<br><br>- **Indicator/**<br>&nbsp;&nbsp;&nbsp;&nbsp;- Main.mqh<br>&nbsp;&nbsp;&nbsp;&nbsp;- OrderBlockIndPart2.mq5 | Includes the Order Blocks indicator, as well as the Expert Advisors used as examples in other articles published by the author (nique_372). |
| **PosManagement** | - **ConditionalPartial/**<br>&nbsp;&nbsp;&nbsp;&nbsp;- Base.mqh<br>&nbsp;&nbsp;&nbsp;&nbsp;- Defines.mqh<br>- Breakeven.mqh<br>- Partials.mqh | Contains libraries for position management:<br>- Breakeven<br>- Partial closure<br>- Conditional partial closure. |
